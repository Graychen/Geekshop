...
$(document).ready(function(){
  ...
  $("#areaId").change(function() {
      ...
      $("#cityId").select2("val", "璇烽€夋嫨鍖�");
      $("#cityId").children().remove().end().append("<option value=\"\">璇烽€夋嫨鍩庡競</option>");
      ...
      $("#locationId").select2("val", "璇烽€夋嫨鍖�");
      $("#locationId").children().remove().end().append("<option value=\"\">璇烽€夋嫨鍖�</option>");
  });
